...
docker buildx build -f ./docker-compose/Dockerfile_robot--platform linux/amd64 -t "interface:latest" --output "type=docker,name=robotui:latest" --build-context project=./ctrlx-datalayer-robotui  .
