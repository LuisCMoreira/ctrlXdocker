...
IMAGE_NAME2="ctrlx-datalayer-robotui"
IMAGE_TAG2="latest"
...
${DOCKER_CLI} buildx build -f ../docker-compose/Dockerfile_robot --platform linux/${TARGET_ARCH} -t ${IMAGE_NAME2}:${IMAGE_TAG2} --output "type=docker,name=${IMAGE_NAME2}:${IMAGE_TAG2}" --build-context project=../ctrlx-datalayer-robotui  .
